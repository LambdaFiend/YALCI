...
alex_table = Data.Array.listArray (0 :: Int, 4773)
  [ 0
  , 50
  , 50
  , 26
...
alex_check = Data.Array.listArray (0 :: Int, 4773)
  [ -1
  , 9
  , 10
  , 39
...
alex_actions = Data.Array.array (0 :: Int, 79)
  [ (78,alex_action_26)
  , (77,alex_action_27)
  , (76,alex_action_28)
  , (75,alex_action_29)
...
alex_action_29 = \pos _ -> Token pos IN
alex_action_30 = \pos _ -> Token pos AS
alex_action_31 = \pos _ -> Token pos LET
alex_action_32 = \pos _ -> Token pos TYNAT
alex_action_33 = \pos _ -> Token pos TYBOOL
alex_action_34 = \pos _ -> Token pos TYUNIT
alex_action_35 = \pos s -> Token pos (NUM $ read s)
alex_action_36 = \pos s -> Token pos $ VAR s
alex_action_37 = \pos s -> Token pos $ ID s
